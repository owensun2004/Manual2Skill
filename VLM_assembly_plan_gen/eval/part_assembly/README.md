Unzip `my_prepare_data_0608.zip` to `PROJ_ROOT/my_prepare_data_0608`.
Then run
```
cd exps/Our_Method-dynamic_graph_learning
python my_test.py --batch_size 1 --category Chair --seed 0 --no_visu
```

The following is the original README in the official repo.
